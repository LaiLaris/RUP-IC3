...
def execute_command_and_get_data(file_path):
    ...
    kind2_command = f"/home/ubuntu/Lustre-exp/bin/exe/RU_l1l2 --enable IC3QE -vv --timeout 290 --color false  {file_path}"
    print(kind2_command)
...
def main():
    ...
    output_file = '/home/ubuntu/Lustre-exp/bin/result/l1l2/RU-IC3_l1l2.csv'  # csv_file
    ...
    with open(output_file, 'w', newline='') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(["Reuse&Unsatcore_file_path", "Reuse&Unsatcore_time", "Reuse&Unsatcore_k", "Reuse&Unsatcore_solver", "Reuse&Unsatcore_neg_state", "Reuse&Unsatcore_num_s", "Reuse&Unsatcore_num_t", "Reuse&Unsatcore_num_gen", "Reuse&Unsatcore_status", "Reuse&Unsatcore_frame_sizes", "Reuse&Unsatcore_elapsed_time"])
