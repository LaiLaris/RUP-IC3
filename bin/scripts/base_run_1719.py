...
def execute_command_and_get_data(file_path):
    kind2_command = f"/home/ubuntu/Lustre-exp/bin/exe/O-IC3 --enable IC3QE  -vv --timeout 290 --color false  {file_path}"
    print(kind2_command)
...
def main():
    ...
    output_file = '/home/ubuntu/Lustre-exp/bin/result/O-IC3_1719.csv'  # csv_file
